...
class AboutDigitalManager extends Component < Props, State > {
  public currentRole: string = Constants.CODE_DIGITAL_MARKETING_MANAGER;
...
export default connect(mapDispatchToProps)(AboutDigitalManager);
